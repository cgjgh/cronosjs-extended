...
test("@hourly", () => {
    expect(CronosExpression.parse("@hourly").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
...
test("@midnight", () => {
    expect(CronosExpression.parse("@midnight").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
...
test("@daily", () => {
    expect(CronosExpression.parse("@daily").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
        new Date(2019, 3, 22, 0, 0, 0),
        new Date(2019, 3, 23, 0, 0, 0),
        new Date(2019, 3, 24, 0, 0, 0),
        new Date(2019, 3, 25, 0, 0, 0),
...
test("@weekly", () => {
    expect(CronosExpression.parse("@weekly").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
...
test("@monthly", () => {
    expect(CronosExpression.parse("@monthly").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
...
test("@annually", () => {
    expect(CronosExpression.parse("@annually").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
...
test("@yearly", () => {
    expect(CronosExpression.parse("@yearly").nextNDates(new Date(2019, 3, 21, 11, 23, 45), 5)).toEqual([
        new Date(2020, 0, 1, 0, 0, 0),
        new Date(2021, 0, 1, 0, 0, 0),
        new Date(2022, 0, 1, 0, 0, 0),
        new Date(2023, 0, 1, 0, 0, 0),
